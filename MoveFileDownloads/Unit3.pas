...
MessageBox(handle, PChar('Введите значения для полей VALUE' + #13#10 + 'Вводите адрес каталогов куда нужно перемещать файлы'), PChar('Warning)'),(MB_OK + MB_ICONWARNING));
end else begin
ShowMessage('Вы что-то ввели');
...
if ValueListEditor1.Strings.Values['PdfFile'] = 'Error' then
  ShowMessage('Укажите параметр Value во всех строчках') else
  begin
